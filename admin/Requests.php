...
<head>
    ...
    <!-- App title -->
    <title><?php echo $_SESSION['names']; ?>| Rending</title>
        ...
        <div id="content" class="p-4 p-md-5">
            ...
            <table id="example" class="display table table-hover" style="width:100%">
                ...
                <tbody>
                    ...
                    ON tbl_request.citizenID = tblcitizen.id WHERE tbl_request.status='1'");
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="Requests.php?citid=<?php echo htmlentities($row['reqID']); ?>"
                                class="btn btn-success btn-sm">YES</a>
                            <a href="Requests.php?darid=<?php echo htmlentities($row['reqID']); ?>"
